...
class App(QtWidgets.QWidget):
    ...
    def load_data(self):
        for file in self.csv_files:
            if os.path.exists(file):
                ...
                self.df['UF'] = self.df['UF'].astype(str)
            else:
    ...
    def init_ui(self):
        ...
        self.setGeometry(750, 300, 500, 550)  
        ...
        self.button_codigo.setFixedSize(250, 45)
        ...
        self.button_nome.setFixedSize(250, 45) 
    ...
    def buscar_nome(self):
        ...
        query = ' & '.join(f'Escola_normalized.str.contains("{word}")' for word in words)  
